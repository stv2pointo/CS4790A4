...
namespace CS4790A4.Controllers
{
    ...
    public class ProposalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,proposalName,isComplete,imagePath")] Proposal proposal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,proposalName,isComplete,imagePath")] Proposal proposal)
        {
            if (ModelState.IsValid)
            {
